...
class Calcu(object):
    ...
    #         nLw = Lw / t_sol / self.tg_sol / mu0 / self.fsol
    #         brdf_factor = self.fq_brdf_correct(nLw=nLw*1., chl=chl*1.)
    #         nLw = nLw * brdf_factor
    #
    ...
    #         print("停止迭代的元素个数：{0}".format(np.sum(~np.isnan(loc_temp))))
    ...
    #     # nLw = nLw * brdf_factor
    #
    #     return [La_final, TLg_final, t_sen_final, t_sol_final, chl]
