...
def model_taua(aermod_index=None, sza=None, saa=None, vza=None, vaa=None, reaa=None, rhoas_nir2=None,
               nir_l_wave: float = None):
    """
...
def calculate(bands=np.array([414., 444, 491, 519, 568, 671, 751, 862]), l_a_nir1=None, l_a_nir2=None, lon=None,
    ...
    # rhoa2小于1e-6视为白气溶胶
    # 重新计算
    rhoa2_nirl = l_a_nir2 * np.pi / F0[-1] / np.cos(sza * np.pi / 180)
    l_a_nir2_part2 = l_a_nir2 * 1.
    rhoa2[np.isnan(rhoa2)] = 999
    l_a_nir2_part2[rhoa2_nirl > 1e-6] = np.nan
