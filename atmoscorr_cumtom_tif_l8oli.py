...
@file: atmoscorr_cumtom_tif_l8oli.py.py
@time: 2022/1/11 15:31
@desc: 从gee下载的landsat8 OLI tif
"""
# -*- coding: utf-8 -*-
import datetime
import os
...
if __name__ == '__main__':
    ...
    filepath = r"F:\cali_spatial_vari\test"  # 数据路径

    files = general.get_filelistv2("LC08_oli_gee_phd", ".tif", path=filepath, mode="all")
    ...
    for num, infile in enumerate(files):
        ...
        outfile = infile.replace(".tif", "_L2A_iterNIR.h5")
