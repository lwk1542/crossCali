...
class SimulationLtoa:
    def __init__(self, target_file: str, ref_file: str, outfile: str,sensorID: Literal["hy1dcocts","hy1dcocts"],
        ...
        self.sensorID_ref = sensorID_ref  
        if self.sensorID=='hy1dcocts':
            self.sensor_alt = 780
    ...
    def pre_parameters(self):
        ...
        if self.sensorID_ref == "modisa":
            self.sensorID_ref_bands = [0, 1, 3, 4, 6, 8, 10, 12]
        if self.sensorID_ref == "s3a_olci" or self.sensorID_ref == "s3b_olci":
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Simulate TOA radiance for cross-calibration.",
        ...
        epilog="""
                ...
                python cross_cal.py \\
                    --sensor_id hy1dcocts \\
                    --sensor_id_ref modisa \\
                    --targetfile satPlatform/AC_l2gen/testdata/H1D_OPER_OCT_L1B_20220208T004000_20220208T004500_08715_10_ROI.h5 \\
                      \\
                    --outfile satPlatform/AC_l2gen/testdata/cross_cal_result.h5
                Short form:

                python cross_cal.py \\
                    -s hy1dcocts \\
                    -sr modisa \\
                    -t satPlatform/AC_l2gen/testdata/H1D_OPER_OCT_L1B_20220208T004000_20220208T004500_08715_10_ROI.h5 \\
                    -r satPlatform/AC_l2gen/testdata/MYD021KM.A2022039.0115.061.2022039152541_seadas_L2_ROI.h5 \\
                    -o satPlatform/AC_l2gen/testdata/cross_cal_result.h5

                Parameter description:

                -s   Sensor ID, for example: hy1dcocts
                -sr  Reference sensor ID, for example: modisa
                -t   Target file path
...
def validate_args(args):
    # if not os.path.exists(args.snrfile):
    #     raise FileNotFoundError(
    #         f"SNR file does not exist: {args.snrfile}"
    #     )
...
if __name__ == '__main__':
    ...
    log_filename = f"cross_cal.log"
    log_path = Path(args.outfile).parent / log_filename
    setup_logging(log_path)
    logging.info("程序启动，环境初始化完成")

    simulate = SimulationLtoa(target_file=args.targetfile, 
                                ref_file=args.referencefile, 
                                outfile=args.outfile,
                                sensorID=args.sensor_id, 
                                sensorID_ref=args.sensor_id_ref)
    toafile = simulate.run_main()

    # python cross_cal.py -s hy1dcocts -sr modisa -t /work2/home_lwk/project/satPlatform/AC_l2gen/testdata/H1D_OPER_OCT_L1B_20220208T004000_20220208T004500_08715_10_ROI.h5 -r /work2/home_lwk/project/satPlatform/AC_l2gen/testdata/MYD021KM.A2022039.0115.061.2022039152541_seadas_L2_ROI.h5 -o /work2/home_lwk/project/satPlatform/AC_l2gen/testdata/1.h5
