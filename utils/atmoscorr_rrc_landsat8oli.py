...
from l2gen import atmosphericParameter, gas_transmittance, rayleigh_rad_V201, get_rhown_nir, aerosol_rad, \
    whitecap_rad, general, get_chl, read_lut, getglint, rayleigh_rad
...
if __name__ == '__main__':
    ...
    # +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    south, north, west, east = 40, 41, -74.7, -73.6  # 20, 41, 116, 130  # 21, 22, 125, 126 # 15, 24.22, 110, 121.5
    sensorID = 'lc08oli'
    sensor_alt = 780
    nonzeroNIR = "want_nirLw"
    filepath = r"G:\SDGsat\calibration\sea\2023\insitu\imagery\forAeronetOC\landsat"  # 数据路径

    files = general.get_filelistv2('LC08_L1TP', "_T1.tar", path=filepath, mode='all')
    ...
    for num, infile in enumerate(files):
        ...
        outfile = infile.replace(".tar", '_L2A_iterNIR.h5')
