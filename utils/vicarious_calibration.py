...
from ObservationGeometry import solar_zenith, solar_azimuth, geometry
...
if __name__ == '__main__':
    ...
    [lut_path, sensor_info,imageinfo] = readfile.get_info(sensorID=sensorID, mode="vc")
    ...
    rhoax, epsnirx, t_sensorx, t_solarx = aerosol
    #
