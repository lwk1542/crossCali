...
@file: ac_main_noNIRItera.py
@time: 2021/7/13 22:17
@desc: 大气校正，非近红外迭代
"""
import datetime
import os
...
if __name__ == '__main__':
    ...
    # +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    south, north, west, east = 20, 41, 116, 130  # 21, 22, 125, 126 # 15, 24.22, 110, 121.5
    sensor_alt = 780
    nonzeroNIR = "want_nirLw"
    filepath = r'G:\high_quality\H1B_70images\crosscalibration\select'  # 数据路径
    files = general.get_filelistv2('H1B_RICH_OCT_L1A', "_crossCalibration.h5", path=filepath, mode='all')
    # +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
        ...
        while last_iter.min() == 0:    # last_iter是一个数组，任何一个像元没有达到停止迭代条件，均需要继续迭代
            ...
            if nonzeroNIR == "want_nirLw":
                ...
                for ib in range(nirs_num, nirl_num + 1):
                    tLw_nir[:, :, ib] = rhown_nir[:, :, ib] / np.pi * Fo[ib] * mu0[:,:,0] * t_sol[:, :, ib] * t_sen[:, :,
                                                                                                       ib] / brdf[:,:,0]
