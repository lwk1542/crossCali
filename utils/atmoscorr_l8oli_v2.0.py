# -*- coding: utf-8 -*-
"""
@Time    : 2023/9/27 20:39
@FileName: atmoscorr_l8oli_v2.0.py
...
class Calcu(object):
    def __init__(self):
        ...
        """
        # ++++++++++++++++++++++++++++++++++需要设置的参数+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
        self.sensorID ="l8oli" #"sdgsat1mii"
        self.sensor_alt = 505
        ...
        self.filespath = r"G:\SDGsat\calibration\sea\2023\insitu\imagery\forAeronetOC\L4B\advance"  # 数据路径
